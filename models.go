...
type BackupStatus struct {
	...
	JobProgressMetadata *JobProgressMetadata `json:"jobProgressMetadata,omitempty"`
...
type Error struct {
	...
	// indication of whether this error can be retried or not.
	IsRetryable *bool `json:"isRetryable,omitempty"`

	// boolean flag to suggest if this errorcode is user created or not.
	...
	// recommendedAction of the error.
...
// JobProgressMetadata - Job In Progress reported Contract.
type JobProgressMetadata struct {
	// Size of data transferred as part of backup or Restore in bytes.
	DataTransferredInBytes *int64 `json:"dataTransferredInBytes,omitempty"`

	// If total data and data transferred is known, Plugins to send the percentage complete also.
	PercentComplete *float64 `json:"percentComplete,omitempty"`

	// Estimated time remaining to complete the data transfer in minutes.
	TimeRemainingInMinutes *int64 `json:"timeRemainingInMinutes,omitempty"`

	// Total data to be transferred as part of backup or Restore in bytes.
	TotalDataInBytes *int64 `json:"totalDataInBytes,omitempty"`
}
...
// VmwareVMProperties - Properties which are specific to vmwares
